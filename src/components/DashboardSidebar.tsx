        ...
        <div className="p-4 bg-white border-t border-slate-200 shadow-[0_-4px_12px_rgba(0,0,0,0.05)] space-y-2">
          ...
          <button 
            ...
            className={`
              ...
              ${hasChanges 
                ? 'bg-[#2D2D24] text-white shadow-lg shadow-black/20 hover:bg-black/80 active:scale-95' 
          ...
          {hasChanges && (
            <p className="text-sm text-[#B7791F] text-center mt-2 animate-pulse font-bold">設定已變更，請點擊更新</p>
          )}
        </div>
