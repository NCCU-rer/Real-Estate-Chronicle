    ...
    <div className="fixed top-4 right-6 z-[100] font-sans" ref={tooltipRef}>
      ...
      <button 
        ...
        className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-200 shadow-md ${
          isOpen ? 'bg-slate-900 text-white rotate-90' : 'bg-white text-slate-500 hover:bg-slate-50'
        }`}
        aria-label="顯示資訊"
      >
      ...
      <div 
        className={`
          absolute top-full right-0 mt-4 w-[calc(100vw-3rem)] sm:w-96 bg-white/95 backdrop-blur-md border border-slate-200 rounded-2xl shadow-2xl p-6
      ...
      >
        <div className="flex items-center gap-2 mb-4 border-b border-slate-100 pb-3">
           ...
           <h3 className="font-bold text-lg text-slate-800">關於本站</h3>
        </div>
